...
const ORGAN_ICONS = {
  ...
  // ── 美容 ──
  teeth: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M10 8.5h12c1.5 0 2.5.8 2 3L22.5 20c-.5 3-1.5 5.5-4 5.5h-5c-2.5 0-3.5-2.5-4-5.5L8 11.5C7.5 9.5 8.5 8.5 10 8.5Z" fill="currentColor" opacity=".9"/><path d="M13.5 9.5v4.5M16 9v5.5M18.5 9.5v4.5" fill="none" stroke="white" stroke-width="1.4" stroke-linecap="round" opacity=".6"/></svg>`,
  hair: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M10.5 6.5C8 9 7.5 13.5 9 18.5c1 3.5 2 6 2 8.5h2.5C13.5 25 12.5 22 12 17.5 11.5 13 12.5 9 14 7c-1.5-2-3-2-3.5-.5ZM16 5c-1.5 2.5-2 7-1 12 .8 4.5 1 7.5 1 9.5h2c0-2-.5-5-1-9.5C16.5 11.5 18 8 20 5.5 19 4.5 17 4.5 16 5ZM21.5 6.5C24 9 24.5 13.5 23 18.5c-1 3.5-2 6-2 8.5h-2.5C18.5 25 19.5 22 20 17.5c.5-4.5-.5-8.5-2-10.5 1.5-2 3-2 3.5-.5Z" fill="currentColor" opacity=".82"/><path d="M13 15c-.5 3 .5 6 1.5 8.5m5-14c.5 3.5-.5 7-1 10" fill="none" stroke="white" stroke-width="1.3" stroke-linecap="round" opacity=".55"/></svg>`,
  lips: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M5 16c2.5-4 5.5-2.5 7.5.5.8 1 1.5 1.5 3.5 1.5s2.7-.5 3.5-1.5C21.5 13.5 24.5 12 27 16c-.5 2.5-2 5-5 6.5-1.5 1-3 1.5-6 1.5s-4.5-.5-6-1.5C7 20 5.5 17.5 5 16Z" fill="currentColor" opacity=".9"/><path d="M5 16c2.5-2 11-2 22 0" fill="none" stroke="white" stroke-width="1.3" stroke-linecap="round" opacity=".5"/><path d="M12.5 17.5c1-.4 2.2-.4 2.8-.2m3.4 0c.6-.2 1.8-.2 2.8.2" fill="none" stroke="white" stroke-width="1.2" stroke-linecap="round" opacity=".68"/></svg>`,
  eyes: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M5 16c2.5-6.5 7.5-9.5 11-9.5S24.5 9.5 27 16c-2.5 6.5-7.5 9.5-11 9.5S7.5 22.5 5 16Z" fill="currentColor" opacity=".82"/><path d="M5 16c2.5-5 7.5-8 11-8s8.5 3 11 8" fill="none" stroke="white" stroke-width="1.3" stroke-linecap="round" opacity=".48"/><circle cx="17.5" cy="15" r="1.8" fill="white" opacity=".72"/></svg>`,
  nails: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M12 11c0-3.5 1.8-6 4-6s4 2.5 4 6v13c0 3-1.8 5-4 5s-4-2-4-5V11Z" fill="currentColor" opacity=".85"/><path d="M13.5 11.5c0 3 .5 5.5.5 7.5m4.5-7.5c0 3-.5 5.5-.5 7.5" fill="none" stroke="white" stroke-width="1.3" stroke-linecap="round" opacity=".52"/><path d="M12.5 22c1.5 1.5 3.5 2 7 1.5" fill="none" stroke="white" stroke-width="1.3" stroke-linecap="round" opacity=".65"/></svg>`,
  breath: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M9.5 20c1.5-3 4-5 6.5-5s5 2 6.5 5c-.5 2.5-3 4.5-6.5 4.5s-6-2-6.5-4.5Z" fill="currentColor" opacity=".88"/><path d="M8 13.5c3.5-4.5 9.5-5.5 15-2.5M9.5 10c3-3.5 9-4.5 13.5-1.5" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" opacity=".62"/><path d="M8 13.5c3.5-4 9.5-5 15-2.5" fill="none" stroke="white" stroke-width="1.2" stroke-linecap="round" opacity=".5"/></svg>`,
  wrinkles: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M16 5C10.5 5 7 9 7 14c0 5.5 3 10 7.5 11.5C15 26 15.5 27.5 16 27.5s1-.5 1.5-2C22 24 25 19.5 25 14c0-5-3.5-9-9-9Z" fill="currentColor" opacity=".82"/><path d="M11 12c2-.8 4.5-.8 6 0M12 15.5c1.5-.5 3-.5 4.5 0m4 0c1-.5 2.5-.5 3.5 0M12.5 19c1.5-.5 3.5-.5 5 0" fill="none" stroke="white" stroke-width="1.3" stroke-linecap="round" opacity=".6"/></svg>`,
  // ── 心理 ──
  anxiety: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M19 5L9.5 17.5h7L9 28l14-13h-7L21 5h-2Z" fill="currentColor" opacity=".88"/><path d="M10 17.5h7m-1.5-3.5H23" fill="none" stroke="white" stroke-width="1.4" stroke-linecap="round" opacity=".62"/></svg>`,
  mood: `<svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="16" cy="16" r="10" fill="currentColor" opacity=".85"/><path d="M11 20.5c1.5 2.5 3 4 5 4s3.5-1.5 5-4M12.5 12.5c0-1 1-1.5 2-1.5m5 0c-1 0-2 .5-2 1.5" fill="none" stroke="white" stroke-width="1.6" stroke-linecap="round" opacity=".72"/><circle cx="13" cy="13.5" r=".9" fill="white" opacity=".75"/><circle cx="19" cy="13.5" r=".9" fill="white" opacity=".75"/><path d="M16 6v2M16 22v2M7 16h2M23 16h2M9.2 9.2l1.4 1.4M22.4 22.4l1 1M9.2 22.8l1.4-1.4M22.4 9.6l1-1" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" opacity=".5"/></svg>`,
  focus: `<svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="16" cy="16" r="11" fill="currentColor" opacity=".42"/><circle cx="16" cy="16" r="7.5" fill="currentColor" opacity=".62"/><circle cx="16" cy="16" r="4.2" fill="currentColor" opacity=".88"/><path d="M16 5v3.5M16 23.5V27M5 16h3.5M23.5 16H27" fill="none" stroke="white" stroke-width="1.5" stroke-linecap="round" opacity=".62"/><circle cx="16" cy="16" r="1.5" fill="white" opacity=".88"/></svg>`,
  memory: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M12.2 7.7c1.4-2.4 5.1-2.4 6.5-.1 2.1-.8 4.8.5 5.3 3 .2.7.1 1.4-.1 2.1 2.2 1.1 3 4 1.8 6.1-.5.9-1.2 1.5-2.1 1.9.1 2.8-2.2 5.2-5.1 5.2-1 0-1.9-.3-2.6-.8-.8.6-1.8.9-2.9.9-2.9 0-5.1-2.3-5-5.1-1.6-.8-2.6-2.3-2.6-4.1 0-1.8 1-3.4 2.6-4.2-.5-2.5 1.4-4.9 4.2-4.9Z" fill="currentColor" opacity=".82"/><circle cx="10.5" cy="16" r="1.5" fill="white" opacity=".72"/><circle cx="16" cy="11.5" r="1.5" fill="white" opacity=".72"/><circle cx="21.5" cy="16" r="1.5" fill="white" opacity=".72"/><circle cx="16" cy="20.5" r="1.5" fill="white" opacity=".72"/><path d="M10.5 16L16 11.5L21.5 16L16 20.5Z" fill="none" stroke="white" stroke-width="1.2" stroke-linejoin="round" opacity=".5"/></svg>`,
  stress: `<svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="16" cy="9" r="3.5" fill="currentColor" opacity=".85"/><path d="M16 12.5c-2.5 1.5-4 4.5-4 7s1.5 5 4 5 4-2.5 4-5-1.5-5.5-4-7Z" fill="currentColor" opacity=".88"/><path d="M12 27c1 .5 2.5 1 4 1s3-.5 4-1" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" opacity=".72"/><path d="M8.5 20C6 18.5 5 15.5 5 13c0-5 4-9 7.5-9M23.5 20c2.5-1.5 3.5-4.5 3.5-7 0-5-4-9-7.5-9" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" opacity=".65"/><path d="M14.5 17c.5-1.5 1.5-2.5 1.5-4" fill="none" stroke="white" stroke-width="1.4" stroke-linecap="round" opacity=".6"/></svg>`,
  sleep: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M20 7C14 7 9 12 9 18s5 11 11 11c3.5 0 6.5-1.5 8.5-4-1.5.5-3 .8-4.5.8C18 25.8 13.5 21 13.5 15.5S18 5.3 24 5.3c.5 0 1 .1 1.5.2C23.5 7.2 20 7.4 20 7Z" fill="currentColor" opacity=".92"/><circle cx="25.5" cy="8" r="1.5" fill="currentColor" opacity=".48"/><circle cx="27" cy="13.5" r="1" fill="currentColor" opacity=".38"/><path d="M11.5 18c0-3.5 1.5-6 4-7.5" fill="none" stroke="white" stroke-width="1.5" stroke-linecap="round" opacity=".65"/></svg>`,
  resilience: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M16 5L4.5 24h23L16 5Z" fill="currentColor" opacity=".85"/><path d="M9.5 21l6.5-11 6.5 11" fill="none" stroke="white" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round" opacity=".62"/><path d="M4 24h24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" opacity=".7"/><path d="M22.5 24l5.5-9-2.5-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" opacity=".55"/></svg>`,
  cravings: `<svg viewBox="0 0 32 32" aria-hidden="true"><rect x="6" y="13" width="9" height="6" rx="3" fill="currentColor" opacity=".85"/><rect x="17" y="13" width="9" height="6" rx="3" fill="currentColor" opacity=".82"/><path d="M15.5 14.5l-.5 3m2.5-3l-.5 3" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" opacity=".65"/><path d="M8 15.5c.5-1 2-1.5 3-1m12.5 0c-.5-1-2-1.5-3-1" fill="none" stroke="white" stroke-width="1.2" stroke-linecap="round" opacity=".6"/></svg>`,
  // ── 男性 ──
  testosterone: `<svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="13" cy="19" r="8" fill="currentColor" opacity=".8"/><path d="M19.5 12.5L25.5 6.5" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" opacity=".9"/><path d="M25.5 6.5H20.5M25.5 6.5V12" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" opacity=".9"/><path d="M9.5 19c0-2.5 1.5-4.5 3.5-5.5" fill="none" stroke="white" stroke-width="1.5" stroke-linecap="round" opacity=".65"/></svg>`,
  virility: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M16 27S5 20 5 12c0-3.5 2.5-5.5 5-5.5 1.8 0 3.5 1 4.5 2.8C15.5 7.5 17 6.5 19 6.5c2.5 0 5 2 5 5.5C24 20 16 27 16 27Z" fill="currentColor" opacity=".9"/><path d="M16 23V14m0 0l-3.5 3.5M16 14l3.5 3.5" fill="none" stroke="white" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" opacity=".72"/></svg>`,
  sperm: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M11 6c0 4 5 7.5 5 11s-5 7.5-5 11M21 6c0 4-5 7.5-5 11s5 7.5 5 11" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" opacity=".85"/><path d="M11.5 10c3 1.5 7.5 1.5 11 0M11 16c3 2 8 2 10 .5M12.5 22c3-2 7-2 9-.5" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity=".52"/><path d="M11.5 10c3 1.5 7.5 1.5 11 0" fill="none" stroke="white" stroke-width="1.1" stroke-linecap="round" opacity=".52"/></svg>`,
  restingHR: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M16 26S5 19.8 5 11.7C5 8.1 7.4 6 10.4 6c2.1 0 3.9 1.2 5.1 3.1C16.8 7.2 18.7 6 20.8 6 23.8 6 27 8.2 27 12.1 27 20 16 26 16 26Z" fill="currentColor" opacity=".88"/><path d="M7 16h3.5l2-5 1.5 10 1.5-5 1.5 3.5 1.5-3.5H23" fill="none" stroke="white" stroke-width="1.65" stroke-linecap="round" stroke-linejoin="round" opacity=".78"/></svg>`,
  muscle: `<svg viewBox="0 0 32 32" aria-hidden="true"><rect x="5.5" y="11.5" width="5.5" height="9" rx="2.8" fill="currentColor" opacity=".82"/><rect x="11" y="14.5" width="10" height="3" fill="currentColor" opacity=".88"/><rect x="21" y="11.5" width="5.5" height="9" rx="2.8" fill="currentColor" opacity=".82"/><path d="M7 13.5v4m3.5 0v-4M22 13.5v4m3.5 0v-4" fill="none" stroke="white" stroke-width="1.3" stroke-linecap="round" opacity=".52"/></svg>`,
  endurance: `<svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="21" cy="7" r="2.5" fill="currentColor" opacity=".88"/><path d="M21 9.5l-3 5.5-6.5 3L13 25M18 15l6 1.5L21.5 22" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" opacity=".88"/><path d="M6 16.5h4m-5.5 3h5" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" opacity=".5"/></svg>`,
  bp: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M7 21C7 14 11 8 16 8s9 6 9 13" fill="none" stroke="currentColor" stroke-width="3.2" stroke-linecap="round" opacity=".72"/><path d="M8.5 20.5C8.5 14.5 12 9.5 16 9.5s7.5 5 7.5 11" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" opacity=".88"/><path d="M16 20.5l3.5-8" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" opacity=".85"/><circle cx="16" cy="21" r="2.5" fill="currentColor" opacity=".9"/><path d="M9.5 14.5l1 1.5M23.5 14l-1 1.5M16 9.5v2" fill="none" stroke="white" stroke-width="1.3" stroke-linecap="round" opacity=".52"/></svg>`,
  endocrine: `<svg viewBox="0 0 32 32" aria-hidden="true"><path d="M16 7v18M10.5 25h11" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" opacity=".8"/><path d="M7 12.5h18" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" opacity=".88"/><path d="M7 12.5c0 4 1.5 6 4.5 6s4.5-2 4.5-6" fill="currentColor" opacity=".78"/><path d="M16 12.5c0 4 1.5 6 4.5 6s4.5-2 4.5-6" fill="currentColor" opacity=".65"/><path d="M8.5 14.5c.5 1.5 1.5 3 3 3m7.5-3c.5 1.5 1.5 3 3 3" fill="none" stroke="white" stroke-width="1.2" stroke-linecap="round" opacity=".58"/></svg>`,
};

const ORGAN_COLORS = {
  // core
  heart: '#ef4444', lung: '#f2a6a8', blood: '#b91c1c', brain: '#a78bfa',
  sense: '#2dd4bf', skin: '#f8c76b', stamina: '#60a5fa', immune: '#f59e0b',
  // 美容
  teeth: '#94a3b8', hair: '#b45309', lips: '#f43f5e', eyes: '#0ea5e9',
  nails: '#c084fc', breath: '#10b981', wrinkles: '#e879f9',
  // 心理
  anxiety: '#f97316', mood: '#fbbf24', focus: '#3b82f6', memory: '#8b5cf6',
  stress: '#059669', sleep: '#6366f1', resilience: '#ef4444', cravings: '#f97316',
  // 男性
  testosterone: '#dc2626', virility: '#e11d48', sperm: '#0284c7',
  restingHR: '#16a34a', muscle: '#2563eb', endurance: '#22c55e',
  bp: '#7c3aed', endocrine: '#d97706',
};
...
function buildConstellation() {
  ...
  ORGANS.forEach((organ, i) => {
    // ATLAS positions are only meaningful for the core category; new categories use circle slots by index.
    const pos = (currentCategoryId === 'core' && ORGAN_ATLAS_POSITIONS[organ.id]) || CIRCLE_POSITIONS[i % 8];
